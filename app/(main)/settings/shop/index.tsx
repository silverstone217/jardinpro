...
const DEFAULT_FORM: ShopFormData = {
  name: "",
  slogan: "",
  telephone: "",
  email: "",
...
const ShopScreen = () => {
  ...
  const [formData, setFormData] = useState<ShopFormData>(DEFAULT_FORM);
   ...
   * TELEPHONE
   *
   * Même logique que ton LoginScreen :
   *
   * - uniquement chiffres
   * - maximum 10
   ...
   * LOGO
   *
   * Ici on sélectionne simplement l'image.
   * L'upload vers Vercel Blob doit être effectué
   * dans ton shopStore.
   */
              ...
              <View style={styles.cardHeader}>
                <View style={styles.cardHeaderText}>
                  ...
                  <Text style={styles.cardDescription}>
                    Votre logo apparaîtra sur vos factures et dans les
                    différents espaces de l&apos;application.
                  </Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  /*
   * IMPORTANT :
   * Le bottom tab est absolute.
   * On réserve donc suffisamment d'espace en bas.
   */
  scrollContent: {
    flexGrow: 1,
