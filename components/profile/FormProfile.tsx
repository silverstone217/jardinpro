...
const FormProfile = ({ user, onBack }: FormProfileProps) => {
  ...
  /*
   * Les valeurs initiales viennent directement de user.
   *
   * Aucun useEffect n'est nécessaire.
   *
   * Le parent utilise key={user.id}, donc si l'utilisateur
   * change, le formulaire est remonté avec les nouvelles valeurs.
   */
  ...
  const handleChangeImage = async () => {
    ...
    try {
      ...
      /*
       * L'image est envoyée directement au serveur
       * Next.js.
       *
       * Le serveur se charge ensuite de l'envoyer
       * à Cloudinary.
       */
